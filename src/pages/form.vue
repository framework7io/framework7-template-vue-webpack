<template>
  <f7-page>
    ...
    <f7-list form>
      <f7-list-item v-for="n in 3" checkbox name="my-checkbox" :key="n" :value="n" :title="'Checkbox ' + n"></f7-list-item>
    </f7-list>

    <f7-block-title>Radios</f7-block-title>
    <f7-list form>
      <f7-list-item v-for="n in 3" radio name="my-radio" :checked="n === 1" :key="n" :value="n" :title="'Radio ' + n"></f7-list-item>
    </f7-list>
